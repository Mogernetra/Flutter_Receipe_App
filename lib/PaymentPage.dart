...
class PaymentPage extends StatefulWidget {
  ...
  const PaymentPage({Key key, this.receipe}) : super(key: key);
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(widget.receipe.calories,style: TextStyle(
                              fontSize: 25,
                          ...
                          Padding(
                            padding: const EdgeInsets.all(16.0),
                            child: Text(widget.receipe.description,style: TextStyle(
